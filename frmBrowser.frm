...
Private Sub Form_Load()
    ...
    Form_Resize
    frmBrowse.Show
    StartingAddress = "http://www.mapquest.com/cgi-bin/ia_find?link=btwn%2Ftwn-map_results&random=565&event=find_search&SNVData=&uid=&address=" & mstrConvertToHtml(Form1.Text2.Text) & "&city=" & mstrConvertToHtml(Form1.Text3.Text) & "&State=" & mstrConvertToHtml(Form1.Text5.Text) & "&Zip=" & mstrConvertToHtml(Form1.Text6.Text) & "&Find+Map.x=29&Find+Map.y=16"
